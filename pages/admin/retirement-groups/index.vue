        ...
        >
          ...
          <div class="w-full flex flex-wrap space-y-2">
            ...
            <div class="w-full flex flex-wrap border-b pb-2 mb-2">
              ...
              <NuxtLink :to="`/admin/retirement-groups/edit/${ retirementGroup.id }`" class="ml-auto">
            ...
            <div class="w-full flex flex-col space-y-4">
              <AppLabelValue class="mb-4">
                <template v-slot:value><span class="border-b-4 pb-1">Regras de aposentadoria</span></template>
              </AppLabelValue>
              <div 
                class="w-full flex pb-2 last:border-b-0 border-b border-zinc-100" 
                v-for="(retirementOption, indexRetirementOption) in retirementGroup.retirementOptions"
