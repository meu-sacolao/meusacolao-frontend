<template>
  <div class="w-full flex flex-col space-y-6">
    ...
    <transition name="slide-left" mode="out-in" appear>
      <TabLogin v-if="tabSelected.value === 'login'" @close="close" @setTabSelected="setTabSelected" skipRedirect="false"/>
      <TabSignup v-else @close="close" @setTabSelected="setTabSelected" skipRedirect="false"/>
    </transition>
